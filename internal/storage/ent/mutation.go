...
func (m *TaskMutation) SetCreateAt(t time.Time) {
	m.create_at = &t
}

// CreateAt returns the value of the "create_at" field in the mutation.
func (m *TaskMutation) CreateAt() (r time.Time, exists bool) {
	v := m.create_at
	if v == nil {
		return
	}
...
// OldCreateAt returns the old "create_at" field's value of the Task entity.
// If the Task object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TaskMutation) OldCreateAt(ctx context.Context) (v time.Time, err error) {
...
func (m *TaskMutation) ResetCreateAt() {
	m.create_at = nil
}
...
func (m *TaskMutation) Fields() []string {
	...
	if m.create_at != nil {
		fields = append(fields, task.FieldCreateAt)
	}
	if m.update_at != nil {
